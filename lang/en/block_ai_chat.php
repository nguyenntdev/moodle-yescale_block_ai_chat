...
$string['aimessage'] = 'AI Assistant message';
$string['aiprocessing'] = 'AI is processing your request';
...
$string['changeview'] = 'Change view mode';
$string['chatactions'] = 'Chat actions';
$string['chathistory'] = 'Chat history';
$string['chatoptions'] = 'Chat options';
...
$string['copymessage'] = 'Copy message to clipboard';
...
$string['inputhelp'] = 'Type your message and press Enter or click the send button to send it to the AI assistant.';
...
$string['messageinput'] = 'Message input area';
$string['name'] = 'Name';
...
$string['usagequota'] = 'Usage quota information';
